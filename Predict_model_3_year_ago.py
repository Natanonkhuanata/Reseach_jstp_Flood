...
name_file = "New_data_Pokun_3_year_ago.xlsx"
...
# Reshape for LSTM
x_input = x_input.reshape(x_input.shape[0], x_input.shape[1], len(feature))
...
y_test_inv = scaler.inverse_transform(y_input_test)
...
plt.plot(y_true, label='y_true', marker='o' , color='red')
plt.plot(y_pred, label='y_pred', linestyle='--', marker='x' , color='blue')
